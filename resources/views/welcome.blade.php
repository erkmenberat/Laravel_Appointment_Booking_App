...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <header class="border-b border-[#19140035] dark:border-[#3E3E3A]">
    <div class="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4">
      <div class="flex items-center gap-3">
        <div class="h-9 w-9 rounded-lg bg-[#1b1b18] dark:bg-[#EDEDEC]"></div>
        <div class="leading-tight">
          <p class="text-sm font-semibold">Unternehmen</p>
          <p class="text-xs text-[#706f6c] dark:text-[#A1A09A]">Terminverwaltung</p>
        </div>
      </div>

      <nav class="flex items-center gap-2">
        <a href="{{ route('login') }}"
           class="inline-flex items-center rounded-md border border-transparent px-4 py-2 text-sm hover:border-[#19140035] dark:hover:border-[#3E3E3A]">
          Log in
        </a>
        <a href="{{ route('register') }}"
           class="inline-flex items-center rounded-md border border-[#19140035] px-4 py-2 text-sm hover:border-[#1915014a] dark:border-[#3E3E3A] dark:hover:border-[#62605b]">
          Register
        </a>
      </nav>
    </div>
  ...
  <main class="mx-auto w-full max-w-6xl px-4 py-8">
    ...
    <section class="grid gap-6 lg:grid-cols-2 lg:items-start">
      <div class="rounded-2xl border border-[#19140035] bg-white p-6 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]
                  dark:border-[#3E3E3A] dark:bg-[#0f0f0f]">
        <h1 class="text-2xl font-semibold tracking-tight">Termin buchen</h1>
        <p class="mt-2 text-sm text-[#706f6c] dark:text-[#A1A09A]">
          Wähle ein Datum und eine Uhrzeit. Danach gibst du nur Name und E-Mail ein.
        </p>

        <!-- Info Pills -->
        <div class="mt-4 flex flex-wrap gap-2">
          <span class="rounded-full border border-[#19140035] px-3 py-1 text-xs dark:border-[#3E3E3A]">Mo–Do 10:00–15:00</span>
          <span class="rounded-full border border-[#19140035] px-3 py-1 text-xs dark:border-[#3E3E3A]">Fr 10:00–13:00</span>
          <span class="rounded-full border border-[#19140035] px-3 py-1 text-xs dark:border-[#3E3E3A]">Sa/So geschlossen</span>
        </div>
      </div>
      ...
      <div class="rounded-2xl border border-[#19140035] bg-white p-6 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]
                  dark:border-[#3E3E3A] dark:bg-[#0f0f0f]">
        <h2 class="text-lg font-semibold">Jetzt buchen</h2>

        <!-- FORM: action später auf deine Route setzen -->
        <form method="POST" action="/book" class="mt-4 space-y-4">
          <!-- Laravel: @csrf -->
          ...
          <div>
            ...
            <input type="date"
                   class="w-full rounded-lg border border-[#19140035] bg-transparent px-3 py-2 text-sm outline-none
                          focus:border-black focus:ring-2 focus:ring-black/10
                          dark:border-[#3E3E3A] dark:focus:border-white dark:focus:ring-white/10" />
            <p class="mt-1 text-xs text-[#706f6c] dark:text-[#A1A09A]">Wähle einen Tag, dann erscheinen verfügbare Zeiten.</p>
          </div>

          <!-- Verfügbare Slots (UI-Dummy: später dynamisch ausgeben) -->
          <div>
            <div class="mb-2 flex items-center justify-between">
              <label class="block text-sm font-medium">Verfügbare Zeiten</label>
              <span class="text-xs text-[#706f6c] dark:text-[#A1A09A]">30-Min Raster</span>
            </div>

            <div class="grid grid-cols-3 gap-2 sm:grid-cols-4">
              <!-- freie Slots -->
              <button type="button" class="rounded-lg border border-[#19140035] px-3 py-2 text-sm hover:border-black dark:border-[#3E3E3A] dark:hover:border-white">
                10:00
              </button>
              <button type="button" class="rounded-lg border border-[#19140035] px-3 py-2 text-sm hover:border-black dark:border-[#3E3E3A] dark:hover:border-white">
                10:30
              ...
              <button type="button" disabled
                      class="cursor-not-allowed rounded-lg border border-[#19140035] px-3 py-2 text-sm opacity-40 dark:border-[#3E3E3A]">
                11:30
              </button>
            ...
            <!-- Hidden field für ausgewählten Slot (später via JS setzen) -->
          ...
          <div class="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <input type="text" name="first_name" placeholder="z. B. Berat"
                     class="w-full rounded-lg border border-[#19140035] bg-transparent px-3 py-2 text-sm outline-none
                            focus:border-black focus:ring-2 focus:ring-black/10
                            dark:border-[#3E3E3A] dark:focus:border-white dark:focus:ring-white/10" />
            </div>
            <div>
              ...
              <input type="text" name="last_name" placeholder="z. B. Erkmen"
                     class="w-full rounded-lg border border-[#19140035] bg-transparent px-3 py-2 text-sm outline-none
                            focus:border-black focus:ring-2 focus:ring-black/10
                            dark:border-[#3E3E3A] dark:focus:border-white dark:focus:ring-white/10" />
            </div>
          ...
          <div>
            ...
            <textarea name="note" rows="3" placeholder="Kurze Info zum Termin…"
                      class="w-full rounded-lg border border-[#19140035] bg-transparent px-3 py-2 text-sm outline-none
                             focus:border-black focus:ring-2 focus:ring-black/10
                             dark:border-[#3E3E3A] dark:focus:border-white dark:focus:ring-white/10"></textarea>
          </div>

          <!-- Submit -->
          <button type="submit"
                  class="w-full rounded-lg bg-[#1b1b18] px-4 py-2.5 text-sm font-medium text-white
                         hover:bg-black dark:bg-[#EDEDEC] dark:text-[#1b1b18] dark:hover:bg-white">
            Termin buchen
          </button>

          <p class="text-center text-xs text-[#706f6c] dark:text-[#A1A09A]">
            Nach dem Buchen erhältst du eine Bestätigung (optional per E-Mail).
          </p>
        </form>
      </div>
    </section>
    ...
    <!-- Footer -->
    <footer class="mt-10 text-center text-xs text-[#706f6c] dark:text-[#A1A09A]">
      © Unternehmen — Terminverwaltung
    </footer>
  </main>
</body>
